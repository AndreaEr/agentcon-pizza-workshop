...
file_ids = [
    project_client.agents.files.upload_and_poll(file_path=os.path.join("workshop/documents", f), purpose=FilePurpose.AGENTS).id
    for f in os.listdir("workshop/documents")
    if os.path.isfile(os.path.join("workshop/documents", f))
]
